...
class myTrack{
	...
	void SetDC1Hit(double x, double y, double z){fDC1Hit->SetXYZ(x,y,z);}
	void SetDC1Hit(TVector3* pos){fDC1HitPos}
	void SetDC2Hit(double x, double y, double z){fDC2Hit->SetXYZ(x,y,z);}
	...
	double* GetConvPos() {return &fConvPos;}
	double* GetCatPos() {return &fCatPos;}
	...
	void GetnpVertex(bool resolution=false){;} 


	void Extrapolate(double xang, double yang, TVector3* pos, double z);	
