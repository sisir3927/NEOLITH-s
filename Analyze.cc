...
Analyze::Analyze(int nRun, bool force):
        fRunNum(nRun){
                ...
                if(force){
                        TFile *fout1 = new TFile (Form("root/sisir/Ana_Data_%d_v10.root",nRun), "RECREATE");
                ...
                TFile *fin = new TFile (Form("root/sisir/Ana_Data_%d_v10.root",nRun), "READ");
                ...
                /*
                   ...
                   */
                TFile *fout2 =new TFile("root/test2_v10.root","RECREATE");
                ...
                fout2 = new TFile("root/test3_v10.root","RECREATE");
        ...
        if(!cath_rat_method){
                ...
                if(v == 'v'){
                        ...
                        if(!Asagi){
                                ...
                                if(dtot_l !=0) wt_l = double(rtot_l);
                                else wt_l = 0.0000001;
...
void Analyze::ModifyTrack(myTrack* track){
        ...
        for(int l =0; l<2;l++){
                ...
                int rattot_r = track->GetVRrattot(l);
                int rattot_l = track->GetVLrattot(l);
          ...
          para = const_cast<myDCHitPara*>(FindDCHitPara(track->GetVID(l)));
                ...
                int dtot_r = track->GetVRdtot(l);
                int dtot_l = track->GetVLdtot(l);
                int rtot_r = track->GetVRrattot(l);
                int rtot_l = track->GetVLrattot(l);
                 strippos = para->GetWirePosition();
...
void Analyze::BookHistograms(){
        ...
        h_alpha = new TH1D("h_alpha","alpha distribution",90,-90,90);
        h_beta = new TH1D("h_beta","beta distribution",90,-90,90);
